...
namespace Task4
{
    ...
    class Tests_Task4
    {
        ...
        public void ManufacturerMustNotBeEmpty()
        {
            Assert.Catch(() =>
            {
                var newBike = new Sportbike("", "Model", 9);
            });
        }
        ...
        public void ModelMustNotBeEmpty()
        {
            Assert.Catch(() =>
            {
                var newBike = new Sportbike("Manufacturer", "", 9);
            });
        }
        ...
        public void MileageMustNotBeNegative()
        {
            Assert.Catch(() =>
            {
                var newBike = new Sportbike("M", "M", -9);
            });
        }
        ...
        {
            var newBike = new Sportbike("Manufacturer", "Model", 123456);
        ...
        {
            var newBike = new Sportbike("Manufacturer", "Model", 10000);
        ...
        {
            var newDirtbike = new Dirtbike("Manufacturer", "Model", 20000);
